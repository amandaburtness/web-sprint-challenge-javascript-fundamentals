...
/* this is a closure. The reason the nested function can access the variable internal is because it is in the correct scope. it is using lexical scope, where the function has a passed down variable, as well as the variable being passed down to it. */
...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(){
    const lowerCase = zooAnimals.map((data) => data.animal_name.toLowerCase());
    return lowerCase;
  }
  ...
  */
  ...
  function lowPopulationAnimals(){
    const pop = zooAnimals.filter((data) => data.population < 5);
    return pop;
  }
  ...
  */
  ...
  function USApop(){
    let totalPop = [];
    totalPop = zooAnimals.reduce((acc, data) => {
